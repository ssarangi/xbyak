...
#error "not supported"
    ...
    public:
            ...
            , scale_(scale)
        {
            ...
            if (r.getBit() >= 128 || scale != 1)
            { 
                // xmm/ymm is always index
                index_.set(r);
            }
            else
            {
    ...
    class CodeLinkedList
    {
        ...
        CodeLinkedList(const CodeLinkedList& rhs);
        void operator=(const CodeLinkedList&);
    ...
    public:
        explicit CodeLinkedList(size_t maxSize, void *userPtr = 0, Allocator *allocator = 0)
    ...
    public:
        ...
        void set(CodeLinkedList *base) { base_ = base; }
    ...
    public:
        ...
        void mov(const Operand& reg1, const Operand& reg2)
        {
            ...
            uint8 code = 0;
            if (reg1.isREG() && reg1.getIdx() == 0 && reg2.isMEM())
            { // mov eax|ax|al, [disp]
                ...
                if (reg1.isMEM() && reg2.isREG() && reg2.getIdx() == 0)
                { // mov [disp], eax|ax|al
...
#include "xbyak_mnemonic.h"
    ...
    class CodeGeneratorLinkedList : public CodeLinkedList
    {
    public:
        enum LabelType
        {
    ...
    public:
        ...
        */
        ...
        CodeGenerator(size_t maxSize = DEFAULT_MAX_CODE_SIZE, void *userPtr = 0, Allocator *allocator = 0)
            : CodeLinkedList(maxSize, userPtr, allocator)
            , mm0(0), mm1(1), mm2(2), mm3(3), mm4(4), mm5(5), mm6(6), mm7(7)
            , xmm0(0), xmm1(1), xmm2(2), xmm3(3), xmm4(4), xmm5(5), xmm6(6), xmm7(7)
            , ymm0(0), ymm1(1), ymm2(2), ymm3(3), ymm4(4), ymm5(5), ymm6(6), ymm7(7)
            , xm0(xmm0), xm1(xmm1), xm2(xmm2), xm3(xmm3), xm4(xmm4), xm5(xmm5), xm6(xmm6), xm7(xmm7) // for my convenience
